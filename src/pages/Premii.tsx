  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-primary mb-4">Premii</h1>
        <p className="text-gray-600 text-lg">Descoperă premiile pentru fiecare categorie de concurs</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 mb-12 transform hover:scale-[1.02] transition-transform duration-300">
        <div className="flex items-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-primary">Finala</h2>
        </div>
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-8 rounded-xl shadow-sm">
          <ul className="space-y-4">
            {[
              ...
              <li key={index} className="flex items-center justify-between group hover:bg-white/50 p-2 rounded-lg transition-colors">
                <div className="flex items-center">
                  <span className={`w-14 h-14 rounded-full flex items-center justify-center mr-5 text-xl font-bold ${
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 mb-12 transform hover:scale-[1.02] transition-transform duration-300">
        <div className="flex items-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-primary">Semi-Finala</h2>
        </div>
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-8 rounded-xl shadow-sm max-w-2xl mx-auto">
          <ul className="space-y-4">
            {[
              { loc: 1, premiu: '900 €' },
              { loc: 2, premiu: '800 €' },
              ...
              <li key={index} className="flex items-center justify-between group hover:bg-white/50 p-2 rounded-lg transition-colors">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700 text-xl">Locul {item.loc}</span>
                </div>
                <span className="font-bold text-primary text-xl group-hover:text-primary/80 transition-colors">
                  {item.premiu}
                </span>
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 mb-12 transform hover:scale-[1.02] transition-transform duration-300">
        <div className="flex items-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-primary">AS</h2>
        </div>
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-8 rounded-xl shadow-sm max-w-2xl mx-auto">
          <ul className="space-y-4">
            {[
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 transform hover:scale-[1.02] transition-transform duration-300">
        <div className="flex items-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-primary">H.S. 1, H.S. 2, H.S. 3</h2>
        </div>
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-8 rounded-xl shadow-sm max-w-2xl mx-auto">
          <p className="text-gray-600 mb-6 text-center italic">Premii identice pentru toate cele trei categorii</p>
          <ul className="space-y-4">
            {[
              { loc: 1, premiu: '100 €' },
              { loc: 2, premiu: '100 €' },
